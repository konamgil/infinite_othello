import type { GameCore, Player, Position, Move, MoveResult, GameResult, GameStatus } from 'shared-types';
...
export declare class GameStateManager {
     ...
     * Get current score
     */
    get score(): import("shared-types").Score;
    /**
    ...
    getGameStats(): {
        totalMoves: number;
        score: import("shared-types").Score;
        gameId: string;
